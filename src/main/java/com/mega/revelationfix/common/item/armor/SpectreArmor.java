...
public class SpectreArmor extends BaseArmorItem implements ISoulRepair, ISoulDiscount {
    public static final AttributeModifier ARMOR_ATTACK_DAMAGE_MODIFIER = new AttributeModifier(UUID.fromString("8ec494ac-5668-44be-af1f-3672b1c8caf7"), "ArmorSet modifier", 5, AttributeModifier.Operation.ADDITION);
