...
public class ModAttributes {
    ...
    public static final RegistryObject<Attribute> SPELL_POWER = ATTRIBUTES.register("spell_power_multiplier", () -> new RangedAttribute("attribute.name." + ModMain.MODID + ".spell_power_multiplier", 0, 0, 32767D).setSyncable(true));
    public static final RegistryObject<Attribute> SPELL_COOLDOWN = ATTRIBUTES.register("spell_cooldown", () -> new RangedAttribute("attribute.name." + ModMain.MODID + ".spell_cooldown", 0, 0, 32767D).setSyncable(true));
