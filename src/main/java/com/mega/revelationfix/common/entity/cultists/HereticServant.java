...
public class HereticServant extends Heretic implements IMonsterServant {
    ...
    static {
        //Summoned
        SUMMONED_FLAGS = SynchedEntityData.defineId(HereticServant.class, EntityDataSerializers.BYTE);
        UPGRADE_FLAGS = SynchedEntityData.defineId(HereticServant.class, EntityDataSerializers.BYTE);
        //Owned
        OWNER_UNIQUE_ID = SynchedEntityData.defineId(HereticServant.class, EntityDataSerializers.OPTIONAL_UUID);
        OWNER_CLIENT_ID = SynchedEntityData.defineId(HereticServant.class, EntityDataSerializers.INT);
    ...
    public static class ChantAtTargetGoal extends Goal {
        ...
        public boolean canUse() {
            if (this.heretic.getChantCoolDown() > 0) {
                ...
                return target != null && target.isAlive() && (double) this.heretic.distanceTo(target) <= this.heretic.getAttributeValue(Attributes.FOLLOW_RANGE) && this.heretic.hasLineOfSight(target);
            }
        }
