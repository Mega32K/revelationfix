...
public class IceHermitModel extends HierarchicalModel<IceHermitEntity> implements ArmedModel, HeadedModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ModMain.MODID, "ice_hermit_layer"), "main");
    ...
    public IceHermitModel(ModelPart root) {
        this.root = root;
    ...
    @Override
    public void setupAnim(@NotNull IceHermitEntity entity, float walkAnimLength, float walkAnimSpd, float tickTime, float headBodyRotDif, float xRot) {
        this.head.yRot = headBodyRotDif * ((float)Math.PI / 180F);
        ...
        if (this.riding) {
            ...
            this.rightArm.xRot = Mth.cos(walkAnimLength * 0.6662F + (float)Math.PI) * 2.0F * walkAnimSpd * 0.5F;
            this.rightArm.yRot = 0.0F;
            this.rightArm.zRot = 0.0F;
            this.leftArm.xRot = Mth.cos(walkAnimLength * 0.6662F) * 2.0F * walkAnimSpd * 0.5F;
            this.leftArm.yRot = 0.0F;
            this.leftArm.zRot = 0.0F;
            this.rightLeg.xRot = Mth.cos(walkAnimLength * 0.6662F) * 1.4F * walkAnimSpd * 0.5F;
            this.rightLeg.yRot = 0.0F;
            this.rightLeg.zRot = 0.0F;
            this.leftLeg.xRot = Mth.cos(walkAnimLength * 0.6662F + (float)Math.PI) * 1.4F * walkAnimSpd * 0.5F;
        ...
        if (abstractillager$illagerarmpose == AbstractIllager.IllagerArmPose.ATTACKING) {
            if (entity.getMainHandItem().isEmpty()) {
                AnimationUtils.animateZombieArms(this.leftArm, this.rightArm, true, this.attackTime, tickTime);
            } else {
                AnimationUtils.swingWeaponDown(this.rightArm, this.leftArm, entity, this.attackTime, tickTime);
            }
            ...
            this.leftArm.z = 0.0F;
            this.leftArm.x = 5.0F;
            this.rightArm.xRot = Mth.cos(tickTime * 0.6662F) * 0.25F;
            this.leftArm.xRot = Mth.cos(tickTime * 0.6662F) * 0.25F;
            ...
            this.rightArm.z = 0.0F;
            this.rightArm.x = -5.0F;
            this.rightArm.xRot = Mth.cos(tickTime * 0.6662F) * 0.05F;
            this.rightArm.zRot = 2.670354F;
            this.rightArm.yRot = 0.0F;
            this.leftArm.z = 0.0F;
            this.leftArm.x = 5.0F;
            this.leftArm.xRot = Mth.cos(tickTime * 0.6662F) * 0.05F;
            this.leftArm.zRot = -2.3561945F;
            this.leftArm.yRot = 0.0F;
        }
        AnimationUtils.bobModelPart(this.rightArm, tickTime, 1.0F);
        AnimationUtils.bobModelPart(this.leftArm, tickTime, -1.0F);
